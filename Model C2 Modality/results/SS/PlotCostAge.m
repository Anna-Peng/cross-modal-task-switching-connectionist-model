...
PlotAgeorCon=input('Plot Age Group or network update probablity? Age=1, Probability=2 ');
...
if PlotAgeorCon==2
    ...
    for i=1:length(analysefile) legendname{i}=sprintf('%s Encode Window=%d', ageinput, probability(i)); end %input('[Enter legend name] ','s'); end
